...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendResetPasswordEmail(String email) {
        log.info("Attempting to send invitation email to reset Password: {}", email);
        ...
        try {
                               ...
                               <table role="presentation" class="card" width="680">
                                 ...
                                 <tr>
                                   <td class="content">
                                     ...
                                     <p class="body-copy">Hello Lawyer,</p>
                                     <p class="body-copy">
                                       We received a request to reset the password for your SecureLaw
                                       account. If you made this request, please click the button
                                     ...
                                     <p class="body-copy">
                                       <strong>Security note:</strong> For your protection, this link
                                       will expire in 24 hours. If you did not request a password
                                       reset, you can safely ignore this email or contact support.
                                     </p>
                                 ...
                                 <tr>
                                   <td class="footer">
                                     ...
                                     only for the recipient. If you received this message in error,
                                     please notify the sender and delete it immediately.
                                     <img
                                       class="footer-logo"
                                       src="images/vertical logo primesprint.png"
                                       alt="Company logo"
                                       width="210"
                                       height="auto"
                                     />
            ...
            String htmlContent = htmlTemplate
                    ...
                    .replace("{{request_time}}", getBeautifulCurrentTime())
                    .replace("{{reset_url}}", frontendLoginUrl + "/reset-password?email=" + email);

            helper.setText(htmlContent, true);
            mailSender.send(message);
            log.info("Invitation email sent successfully to: {}", email);
        } catch (Exception exception) {
            log.warn("Email send attempt failed for pwd reset {}: {}", email, exception.getMessage());
            throw new IllegalStateException("Failed to send invitation email", exception);
        }
    }

    public static String getBeautifulCurrentTime() {
